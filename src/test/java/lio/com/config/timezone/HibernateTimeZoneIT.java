package lio.com.config.timezone;

import lio.com.BabylioApp;
import lio.com.repository.timezone.DateTimeWrapper;
import lio.com.repository.timezone.DateTimeWrapperRepository;
...
public class HibernateTimeZoneIT {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM lio_date_time_wrapper where id=%d", fieldName, id);
    }
